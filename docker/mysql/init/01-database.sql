...
CREATE DATABASE IF NOT EXISTS delhivery_app;
CREATE DATABASE IF NOT EXISTS delhivery_app_test;
...
GRANT ALL ON `delhivery_app`.*      TO 'app'@'%';
GRANT ALL ON `delhivery_app_test`.* TO 'app'@'%';
FLUSH PRIVILEGES;
