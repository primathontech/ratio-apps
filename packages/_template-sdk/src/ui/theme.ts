 ...
 */
export interface __Slug__ThemeInput {
  primary?: string;
  radius?: string;
}
 ...
 */
export function themeVars(theme: __Slug__ThemeInput): string {
...
/**
 * Shared resets + token-driven helpers imported by every __Slug__ UI component.
