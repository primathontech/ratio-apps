// TEMPLATE: Lit `<__slug__-facet-list>` component. Customize the custom-element tag and the facet shape to match this vendor.
import { css, html, LitElement } from 'lit';
import { customElement, property } from 'lit/decorators.js';
import { baseStyles } from './theme';

/**
 * `<__slug__-facet-list>` — a multi-select checkbox facet.
 *
 ...
 * `__slug__-facet-change` event with `{ key, selected }`.
 *
 * Standalone: used only by the lazy-loaded results page.
 */
@customElement('__slug__-facet-list')
export class __Slug__FacetList extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    '__slug__-facet-list': __Slug__FacetList;
  }
}
