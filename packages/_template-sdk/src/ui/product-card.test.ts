...
import './product-card';
import type { __Slug__ProductCard } from './product-card';
...
async function mount() {
  const el = document.createElement('__slug__-product-card') as __Slug__ProductCard;
...
describe('__slug__-product-card', () => {
