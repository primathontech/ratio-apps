// TEMPLATE: Lit `<__slug__-product-card>` component. Customize the custom-element tag, the `__Slug__Product` shape, and currency/locale formatting to match this vendor.
import type { __Slug__Product } from '@ratio-app/shared';
...
/**
 * `<__slug__-product-card>` — a single search-result product tile.
 *
 ...
 */
@customElement('__slug__-product-card')
export class __Slug__ProductCard extends LitElement {
  ...
  @property({ attribute: false }) product!: __Slug__Product;
...
declare global {
  interface HTMLElementTagNameMap {
    '__slug__-product-card': __Slug__ProductCard;
  }
}
