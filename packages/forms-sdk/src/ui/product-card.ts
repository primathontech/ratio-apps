// TEMPLATE: Lit `<forms-product-card>` component. Customize the custom-element tag, the `FormsProduct` shape, and currency/locale formatting to match this vendor.
import type { FormsProduct } from '@ratio-app/shared';
...
/**
 * `<forms-product-card>` — a single search-result product tile.
 *
 ...
 */
@customElement('forms-product-card')
export class FormsProductCard extends LitElement {
  ...
  @property({ attribute: false }) product!: FormsProduct;
...
declare global {
  interface HTMLElementTagNameMap {
    'forms-product-card': FormsProductCard;
  }
}
