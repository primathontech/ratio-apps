...
export function ScriptTagPanel({ merchantId }: Props) {
  ...
  const apiBase = rawBase.endsWith('/') ? `${rawBase.slice(0, -1)}/google` : `${rawBase}/google`;
  ...
  return (
    ...
    >
      ...
      <Typography.Paragraph type="secondary" style={{ marginBottom: 0 }}>
        The PixelRuntime then activates the <Typography.Text code>google-ratio</Typography.Text> SDK
