import type { GoogleConfig, GoogleConfigInput } from '@shared/schemas/google-config';
...
export function useConfig() {
  ...
  return useQuery({
    ...
    queryFn: () => api<GoogleConfig>('GET', '/api/google-config'),
...
export function useUpdateConfig() {
  ...
  return useMutation({
    mutationFn: (input: GoogleConfigInput) => api<GoogleConfig>('PUT', '/api/google-config', input),
    onSuccess: (data) => {
