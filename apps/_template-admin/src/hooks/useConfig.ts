import type { TemplateConfig, TemplateConfigInput } from '@shared/schemas/_template-config';
...
export function useConfig() {
  ...
  return useQuery({
    ...
    queryFn: () => api<TemplateConfig>('GET', '/api/_template-config'),
...
export function useUpdateConfig() {
  ...
  return useMutation({
    mutationFn: (input: TemplateConfigInput) =>
      api<TemplateConfig>('PUT', '/api/_template-config', input),
    onSuccess: (data) => {
