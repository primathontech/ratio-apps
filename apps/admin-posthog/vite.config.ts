...
export default defineConfig({
  ...
  server: {
    port: 5173,
    proxy: {
      '/posthog/api': { target: 'http://localhost:3000', changeOrigin: true },
      '/posthog/sdk': { target: 'http://localhost:3000', changeOrigin: true },
      '/posthog/auth': { target: 'http://localhost:3000', changeOrigin: true },
    },
  },
  test: {
