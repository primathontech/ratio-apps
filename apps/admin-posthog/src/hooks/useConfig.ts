import type { PostHogConfig, PostHogConfigInput } from '@shared/schemas/posthog-config';
...
export function useConfig() {
  ...
  return useQuery({
    ...
    queryFn: () => api<PostHogConfig>('GET', '/api/posthog-config'),
...
export function useUpdateConfig() {
  ...
  return useMutation({
    mutationFn: (input: PostHogConfigInput) =>
      api<PostHogConfig>('PUT', '/api/posthog-config', input),
    onSuccess: (data) => {
