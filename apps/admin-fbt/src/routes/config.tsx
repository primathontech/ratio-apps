...
function ConfigPage() {
  ...
  return (
    <FormProvider {...form}>
      <Card
        title="Fbt credentials"
        extra={
          <Typography.Text type="secondary">
            Fbt → Project Settings → Project API Key (starts with <code>phc_</code>)
          </Typography.Text>
        }
      >
        <form
          onSubmit={form.handleSubmit(
            ...
            (errors) => {
              ...
              console.warn('Fbt config form validation failed:', errors);
              form.setError('root', {
                type: 'validation',
                message:
        ...
        >
          <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
            ...
            <FieldRow
              ...
              hint="US: https://us.i.fbt.com · EU: https://eu.i.fbt.com · or your self-hosted https URL"
            >
              <Controller
                control={form.control}
                name="host"
                render={({ field, fieldState }) => (
                  <Input
                    {...field}
                    placeholder="https://us.i.fbt.com"
                    {...(fieldState.invalid ? { status: 'error' as const } : {})}
                  />
                )}
              />
