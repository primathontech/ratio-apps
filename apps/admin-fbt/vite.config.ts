...
export default defineConfig({
  ...
  server: {
    port: 5173,
    proxy: {
      '/fbt/api': { target: 'http://localhost:3000', changeOrigin: true },
      '/fbt/sdk': { target: 'http://localhost:3000', changeOrigin: true },
      '/fbt/auth': { target: 'http://localhost:3000', changeOrigin: true },
    },
  },
  test: {
