...
import { FbtSdkService } from './sdk.service';

@Controller('fbt/sdk')
export class FbtSdkController {
  constructor(private readonly sdk: FbtSdkService) {}

  /**
   * Browser-facing endpoint. The merchant pastes
   *   <script src="https://.../fbt/sdk/<merchantId>.js" defer></script>
   ...
   * inside `FbtSdkService.render`, after every error branch has
   * already thrown.
   */
  @Get(':merchantId.js')
