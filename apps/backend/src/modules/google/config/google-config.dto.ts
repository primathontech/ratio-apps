 ...
 *
 * `UpdateConfigDto` is just the shared `GoogleConfigInput` — we re-export
 ...
 */
export const updateConfigDtoSchema = googleConfigInputSchema;
export type UpdateConfigDto = GoogleConfigInput;
