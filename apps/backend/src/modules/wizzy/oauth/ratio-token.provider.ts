...
import { WIZZY_CRYPTO, WIZZY_RATIO_OAUTH_CREDS, WIZZY_RATIO_OAUTH_HTTP } from '../tokens';
...
export class RatioTokenProvider {
  constructor(
    ...
    @Inject(WIZZY_RATIO_OAUTH_HTTP) private readonly http: RatioOAuthHttp,
    @Inject(WIZZY_RATIO_OAUTH_CREDS) private readonly creds: RatioOAuthCreds,
  ) {}
