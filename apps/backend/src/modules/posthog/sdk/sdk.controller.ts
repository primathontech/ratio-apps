...
import { PosthogSdkService } from './sdk.service';

@Controller('posthog/sdk')
export class PosthogSdkController {
  constructor(private readonly sdk: PosthogSdkService) {}

  /**
   * Browser-facing endpoint. The merchant pastes
   *   <script src="https://.../posthog/sdk/<merchantId>.js" defer></script>
   ...
   * inside `PosthogSdkService.render`, after every error branch has
   * already thrown.
   */
  @Get(':merchantId.js')
