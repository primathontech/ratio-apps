...
@Injectable()
export class ClevertapReviewCreatedHandler implements WebhookHandler {
  readonly topic = CLEVERTAP_WEBHOOK_TOPICS.reviewsCreate;
  ...
  handle(
    ...
    return this.forwarding.forwardReviewEvent(this.topic, data, merchantId, trx);
  }
}
