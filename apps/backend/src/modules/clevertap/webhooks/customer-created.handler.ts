...
@Injectable()
export class ClevertapCustomerCreatedHandler implements WebhookHandler {
  readonly topic = CLEVERTAP_WEBHOOK_TOPICS.customersCreate;
  ...
  handle(
    ...
    return this.forwarding.forwardCustomerProfile(this.topic, data, merchantId, trx);
  }
}
