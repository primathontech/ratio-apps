...
export default defineConfig({
  ...
  server: {
    port: 5173,
    proxy: {
      '/clevertap/api': { target: 'http://localhost:3000', changeOrigin: true },
      '/clevertap/sdk': { target: 'http://localhost:3000', changeOrigin: true },
      '/clevertap/auth': { target: 'http://localhost:3000', changeOrigin: true },
    },
  },
  test: {
